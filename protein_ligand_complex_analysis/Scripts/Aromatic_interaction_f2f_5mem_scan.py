...
filetxt.close()
fileout=open('out_aromatic_interaction_f2f_5mem_scan.txt','w')
f1=open('error_aromatic_interaction_f2f_5mem_scan.txt','w')
intr=[]
...
for ppp in range(lenlines):
    ...
    for i in range(0,len(y)):
        #print (y[i])
        if is_number(y[i][0]) == True and float(y[i][2])==5:
            ...
            for z3 in range(len(Z)):
                for z4 in range(len(Z)):
                    for z5 in range(len(Z)):
                        if Z[z1].armi==Z[z2].armi==Z[z3].armi==Z[z4].armi==Z[z5].armi and Z[z1].aid>Z[z2].aid>Z[z3].aid>Z[z4].aid>Z[z5].aid:
                            atm=atom()
                            atm.armi=Z[z1].armi
                            atm.x=(Z[z1].x+Z[z2].x+Z[z3].x+Z[z4].x+Z[z5].x)/5
                            atm.y=(Z[z1].y+Z[z2].y+Z[z3].y+Z[z4].y+Z[z5].y)/5
                            atm.z=(Z[z1].z+Z[z2].z+Z[z3].z+Z[z4].z+Z[z5].z)/5
    ...
    intr=[]
    fileout.close()
    fileout=open('out_aromatic_interaction_f2f_5mem_scan.txt','a')
fileout.close()
f1.close()
