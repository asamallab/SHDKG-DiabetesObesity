...
filetxt.close()
fileout=open('out_aromatic_interaction_f2h_5mem_scan.txt','w')
f1=open('error_aromatic_interaction_f2h_5mem_scan.txt','w')
intr=[]
...
for ppp in range(lenlines):
    ...
    intr=[]
    fileout.close()
    fileout=open('out_aromatic_interaction_f2h_5mem_scan.txt','a')
fileout.close()
f1.close()
