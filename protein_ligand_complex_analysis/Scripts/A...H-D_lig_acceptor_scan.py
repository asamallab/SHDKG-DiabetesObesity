...
filetxt.close()
#fileout=open('out_A...H-D_lig_acceptor_scan.txt','w')
fileout=open(sys.argv[2],'w')
#f1=open('error_A...H-D_lig_acceptor_scan.txt','w')
...
for ppp in range(lenlines):
        ...
        for ln in lines:
            if len(ln)>=6 and (ln[0:4]=='ATOM' or ln[0:6]=='HETATM'):
                ...
                if ln[0:6]=='HETATM' :
                    ...
                    atm.symb=ln[76:78].strip()
                    #print(atm.aid)     
                    if (atm.symb=='O' or atm.symb=='N' or atm.symb=='S')and (modelno=='1' or modelno=='A' or modelno==[]) :
                        A.append(atm)      
    ...
    intr=[]
    fileout.close()
    #fileout=open('out_A...H-D_lig_acceptor_scan.txt','a')
