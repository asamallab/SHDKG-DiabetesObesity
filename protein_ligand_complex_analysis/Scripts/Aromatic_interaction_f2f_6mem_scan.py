...
filetxt.close()
fileout=open('out_aromatic_interaction_f2f_6mem_scan.txt','w')
f1=open('error_aromatic_interaction_f2f_6mem_scan.txt','w')
intr=[]
...
for ppp in range(lenlines):
    ...
    for i in range(0,len(y)):
        if is_number(y[i][0]) == True and float(y[i][2])==6:
                ...
                for z4 in range(len(Z)):
                    for z5 in range(len(Z)):
                        for z6 in range(len(Z)):
                            if Z[z1].armi==Z[z2].armi==Z[z3].armi==Z[z4].armi==Z[z5].armi==Z[z6].armi and Z[z1].aid>Z[z2].aid>Z[z3].aid>Z[z4].aid>Z[z5].aid>Z[z6].aid:
                                atm=atom()
                                atm.armi=Z[z1].armi
                                atm.x=(Z[z1].x+Z[z2].x+Z[z3].x+Z[z4].x+Z[z5].x+Z[z6].x)/6
                                atm.y=(Z[z1].y+Z[z2].y+Z[z3].y+Z[z4].y+Z[z5].y+Z[z6].y)/6
                                atm.z=(Z[z1].z+Z[z2].z+Z[z3].z+Z[z4].z+Z[z5].z+Z[z6].z)/6
                    ...
                    for z1 in range(len(Z)):
                        for z2 in range(len(Z)):
                            for x2 in range(len(X2)):
                                if Z[z1].rid==Z[z2].rid==X2[x2].rid and Z[z1].chainid==Z[z2].chainid==X2[x2].chainid and Z[z1].aid>Z[z2].aid  and getlen(X1[x1],X2[x2])<=4.4 and getanglebetweenplanes(C1[c1],C2[c2],X1[x1],Z[z1],Z[z2],X2[x2])<=30:
                                    intr.append([])
    ...
    intr=[]
    fileout.close()
    fileout=open('out_aromatic_interaction_f2f_6mem_scan.txt','a')
fileout.close()
f1.close()
